...
# Channel Access Token 和 Channel Secret 從環境變數中取得
CHANNEL_ACCESS_TOKEN = os.getenv("ZXxMakoI5GNuejiC7Igzm1wvqw3vDxHGRlicvQPM1qizx9eqUJSouLzo1rbTZxo24IWBi0E3AP8lBSOj7SRVt0GkK5Duowbfjn")
CHANNEL_SECRET = os.getenv("4226f38b9cd8bce4d0417d29d575f750")
...
def handle_location_message(event):
    ...
    if restaurant:
        ...
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(text="抱歉，附近沒有找到餐廳")
        )
